...
ProviderData2023$Outcomes.for.children.and.young.people <- NA
ProviderData2023$Health.services <- NA
ProviderData2023$Quality.of.care <- NA



names(ProviderData2023)[names(ProviderData2023)=="Short.break.only.children.s.home"] <- "Short.Breaks.Only"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.event.number"] <- "Event.number"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.event.type"] <- "Event.type"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.publication.date"] <- "Publication.date"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.overall.experiences.and.progress.of.children.and.young.people"] <- "Overall.experiences.and.progress.of.children.and.young.people"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.outcomes.in.education.and.related.learning.activities"] <- "Outcomes.in.education.and.related.learning.activities"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.how.well.children.and.young.people.are.helped.and.protected"] <- "How.well.children.and.young.people.are.helped.and.protected"
names(ProviderData2023)[names(ProviderData2023)=="Inspection.the.effectiveness.of.leaders.and.managers"] <- "The.effectiveness.of.leaders.and.managers"

#check for any different column names
setdiff(names(ProviderData2023), names(ProviderData2020))
...
ProviderData2023$Organisation.which.owns.the.provider[ProviderData2023$Organisation.which.owns.the.provider== "Pathway Care Solutions Ltd 04004053"] <- "Pathway Care Solutions Ltd"
ProviderData2023$Organisation.which.owns.the.provider[ProviderData2023$Organisation.which.owns.the.provider== "Social Care Services Ltd"] <- "Social Care Services Limited"
ProviderData2023$Organisation.which.owns.the.provider[ProviderData2023$Organisation.which.owns.the.provider== "The SENAD Group Limited"] <- "The Senad Group Limited"
ProviderData2023$Organisation.which.owns.the.provider[ProviderData2023$Organisation.which.owns.the.provider== "Cambian Childcare Ltd"] <- "Cambian Childcare Limited"
